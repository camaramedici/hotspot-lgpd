    ...
    <>
      <div className="bg-blue-900/40 border border-blue-400/30 rounded-xl p-3 mb-5 text-left">
        ...
        <p className="text-xs text-justify text-blue-300 leading-relaxed">
          ...
          <button
            onClick={onOpenModal}
            className="text-yellow-300 underline hover:text-yellow-100 transition font-bold text-right text-sm bg-yellow-400/10 px-1.5 py-0.5 rounded hover:bg-yellow-400/20"
          >
            Saiba mais
          </button>
        </p>
